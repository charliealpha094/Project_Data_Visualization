...
#try_15.4- Modified Random Walks
...
class RandomWalk:
    ...
    def fill_walk(self):
        ...
        while len(self.x_values) < self.num_points:
            ...
            #Decide in which direction to go and how to go in that direction.
            x_direction = choice([2, -2])
            x_distance = choice([0, 1, 3, 5, 7, 8])
            x_step = x_direction * x_distance

            y_direction = choice([2, -2])
            y_distance = choice([0, 1, 3, 5, 7, 8])
